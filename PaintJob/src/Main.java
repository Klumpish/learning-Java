...
//        System.out.println(getBucketCount(7.25, 4.3, 2.35));
    ...
    public static int getBucketCount(double width, double height,
        ...
        double areaLeftToPaint = totalArea - areaCoveredByExtras;
        if (areaLeftToPaint < 0) {
            areaLeftToPaint = 0;
        }
        double bucketsToBuy = Math.ceil(areaLeftToPaint / areaPerBucket);
    ...
    public static int getBucketCount(double width, double height,
        ...
        double totalArea = width * height;
        double bucketsToBuy = Math.ceil(totalArea / areaPerBucket);
